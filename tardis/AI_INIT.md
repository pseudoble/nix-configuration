...
**IMPORTANT: NEVER RUN SUDO COMMANDS**
- Claude Code must NEVER execute commands with `sudo` directly
- If a command requires sudo, provide the command to the user and ask them to run it
- Wait for the user to report back with the output
